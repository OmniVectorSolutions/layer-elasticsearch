...
#@when(
#    'endpoint.provide-master-to-data.joined',
#)
#def provide_master_node_type_relation_data():
#    if not ES_NODE_TYPE == 'master':
#        log('SOMETHING BAD IS HAPPENING - wronge node type for relation')
...
#        return
#    else:
#        endpoint_from_flag('endpoint.provide-master-to-data.joined').configure(
#            ES_CLUSTER_INGRESS_ADDRESS,
#            ES_TRANSPORT_PORT,
#            ES_CLUSTER_NAME
#        )
#        set_flag('elasticsearch.at.least.one.data.node')
#
#
## Master <-> ingest relation
#@when(
#    'endpoint.provide-master-to-ingest.joined',
#)
#def provide_master_node_type_relation_data():
#    if not ES_NODE_TYPE == 'master':
#        log('SOMETHING BAD IS HAPPENING - wronge node type for relation')
...
#        return
#    else:
#        endpoint_from_flag('endpoint.provide-master-to-ingest.joined').configure(
#            ES_CLUSTER_INGRESS_ADDRESS,
#            ES_TRANSPORT_PORT,
#            ES_CLUSTER_NAME
#        )
